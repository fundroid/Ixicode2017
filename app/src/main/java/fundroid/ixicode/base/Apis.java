...
public class Apis {
    ...
    public static String[] pointTypes = {"Places To Visit", "Hotel", "Things To Do", "Accommodation"};
    ...
    public static final String URL_FOR_MAP = "https://maps.googleapis.com/maps/api/staticmap?center=<LAT>,<LNG>&zoom=6&size=400x300&key=AIzaSyAl1htxIonUsb4vRjQgljDf0dWU03g3oCY";
}